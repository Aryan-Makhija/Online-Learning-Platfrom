    ...
    <div className="bg-[#fcfbf7] text-slate-800 min-h-screen font-sans selection:bg-amber-200 selection:text-slate-900">
      ...
      <section className="relative pt-36 pb-20 md:pt-44 md:pb-28 px-6 max-w-7xl mx-auto overflow-hidden">
        ...
        <motion.div
          ...
          className="mt-14 max-w-4xl mx-auto rounded-2xl bg-white border border-amber-900/10 p-3 sm:p-4 shadow-xl shadow-amber-900/5 relative z-10"
        >
          {/* Mockup Header bar */}
          <div className="flex items-center justify-between px-4 py-2.5 bg-slate-50 rounded-xl border border-slate-200 mb-3">
            <div className="flex items-center gap-2">
              <div className="w-2.5 h-2.5 rounded-full bg-rose-400"></div>
              <div className="w-2.5 h-2.5 rounded-full bg-amber-400"></div>
              <div className="w-2.5 h-2.5 rounded-full bg-emerald-400"></div>
              <span className="ml-2 text-xs text-slate-500 font-mono hidden sm:inline">eduai-workspace.app/course/builder</span>
            </div>
            <div className="flex items-center gap-1.5 text-xs text-amber-800 bg-amber-50 px-2.5 py-0.5 rounded-md border border-amber-200">
              <Sparkles className="w-3 h-3 text-amber-600" /> AI Engine Active
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-3 text-left">
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 flex flex-col justify-between">
              <div>
                <p className="text-xs text-amber-700 font-semibold uppercase tracking-wider mb-2">Prompt Input</p>
                <div className="bg-white p-3 rounded-lg border border-slate-200 text-xs text-slate-700 font-mono leading-relaxed">
                  &quot;Generate an advanced 4-chapter track on full-stack web development with Next.js and real-time sockets.&quot;
                </div>
              </div>
            ...
            <div className="md:col-span-2 bg-slate-50 p-4 rounded-xl border border-slate-200">
              <p className="text-xs text-amber-700 font-semibold uppercase tracking-wider mb-3">Live Generated Outline</p>
              <div className="space-y-2">
                {[
                  { title: "1. Next.js App Router Architecture", status: "Completed", color: "text-emerald-600 bg-emerald-50" },
                  { title: "2. Real-Time Sockets & State Sync", status: "In Progress", color: "text-amber-700 bg-amber-50" },
                  { title: "3. Vector Databases & AI Integration", status: "Queued", color: "text-slate-400 bg-slate-100" },
                  { title: "4. Deployment & Performance Tuning", status: "Queued", color: "text-slate-400 bg-slate-100" },
                ].map((item, idx) => (
                  <div key={idx} className="flex items-center justify-between bg-white p-2.5 rounded-lg border border-slate-200 text-xs sm:text-sm">
                    <span className="text-slate-800 font-medium">{item.title}</span>
                    <span className={`text-xs px-2 py-0.5 rounded font-medium ${item.color}`}>{item.status}</span>
                  </div>
                ))}
              </div>
            </div>
