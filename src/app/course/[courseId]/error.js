      ...
      <div className="max-w-md w-full text-center bg-white border border-slate-200/80 rounded-3xl p-8 shadow-xl shadow-slate-900/5 relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Button
            asChild
            variant="outline"
            className="w-full sm:w-auto h-11 px-6 rounded-xl border-slate-200 hover:bg-slate-50 text-slate-700 font-semibold text-xs sm:text-sm flex items-center justify-center gap-2"
          >
            <Link href="/workspace">
