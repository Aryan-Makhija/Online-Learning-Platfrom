...
// import EnrollCourseList from '@/components/WorkspceComponents/EnrollCourseList'
// import WelcomeBanner from '@/components/WorkspceComponents/WelcomeBanner'
// import WorkspaceNavbar from '@/components/WorkspceComponents/AppHeader'

// const WorkSpace = () => {
//   // Active Tab state handles clutter by showing explicitly selected views
...
//       <WorkspaceNavbar activeTab={activeTab} setActiveTab={setActiveTab} />
...
//         {/* SECTION NAVIGATION & TAB HEADERS */}
...
//                 {activeTab === 'enrolled'
//                   ? 'Continue where you left off and keep track of your active progress.'
//                   : 'Browse community and AI-generated courses available to enroll.'}
//               </p>
//             </div>

//             {/* SECONDARY TAB SWITCHER */}
//             <div className="inline-flex bg-slate-200/70 p-1 rounded-2xl self-start sm:self-auto border border-slate-300/50">
//               <button
