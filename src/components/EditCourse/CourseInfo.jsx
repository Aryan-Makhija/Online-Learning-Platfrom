...
//       className="bg-white border border-amber-200/70 rounded-3xl p-4 sm:p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow overflow-hidden"
//     >
...
//                 className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-amber-100 text-amber-900 border border-amber-200/80"
//               >
...
//                 <motion.span 
//                   whileHover={{ scale: 1.03 }}
//                   className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold bg-slate-100 text-slate-700 capitalize border border-slate-200"
//                 >
...
//           {/* METRICS GRID - FULLY RESPONSIVE FOR MOBILE */}
//           <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3 w-full">

//             {/* STAT 1: CUMULATIVE DURATION */}
//             <div className="flex items-center gap-3 p-3 rounded-2xl bg-amber-50/70 border border-amber-100 min-w-0 w-full">
...
//             {/* STAT 3: TOTAL TOPICS / DIFFICULTY */}
//             <div className="flex items-center gap-3 p-3 rounded-2xl bg-amber-50/70 border border-amber-100 min-w-0 w-full">
//               <div className="p-2.5 bg-amber-100 text-amber-800 rounded-xl shrink-0">
...
//                 disabled={loading}
//                 className="w-full sm:w-auto px-6 sm:px-8 py-5 sm:py-6 text-sm sm:text-base font-bold bg-amber-600 hover:bg-amber-700 text-white rounded-2xl shadow-lg shadow-amber-600/20 transition-all hover:scale-[1.01] active:scale-[0.99] gap-2"
//               >
//                 {loading ? (
//                   <>
...
//                 <Button className="w-full sm:w-auto px-6 sm:px-8 py-5 sm:py-6 text-sm sm:text-base font-bold bg-amber-600 hover:bg-amber-700 text-white rounded-2xl shadow-lg shadow-amber-600/20 transition-all hover:scale-[1.01] active:scale-[0.99] gap-2">
...
//           className="w-full lg:w-80 h-48 sm:h-56 lg:h-auto min-h-[200px] rounded-2xl bg-gradient-to-br from-amber-500 via-amber-600 to-amber-800 p-5 sm:p-6 flex flex-col justify-between text-white relative overflow-hidden shadow-inner shrink-0"
//         >
...
//             <span className="px-3 py-1 bg-white/20 backdrop-blur-md rounded-full text-xs font-semibold tracking-wide border border-white/20 truncate">
//               Interactive Guide
//             </span>
//             <BookOpen className="w-5 h-5 text-amber-200 opacity-80 shrink-0" />
//           </div>

//           <div className="relative z-10 space-y-1">
//             <p className="text-[10px] sm:text-xs uppercase tracking-widest text-amber-200 font-semibold">Course Syllabus</p>
//             <h2 className="text-lg sm:text-xl font-extrabold line-clamp-2 leading-snug drop-shadow-sm">
//               {courselayout?.name || course?.name}
//             </h2>
//           </div>
//         </motion.div>
